...
namespace OpenUtau.Core.HifiNeural {
    ...
    public static class HifiRenderConfig {
        ...
        public static string CacheKey() {
            return $"v74-finegridconcat-minxfade-boundarybias-boundarysmooth-srcf0comp-f0center-hnsepfilecache-sharedtailtrim-autosourcestartcatchup-he-timewarpname-autohe-stretchtiers-legacyhecompat-stablesustainresidualloop-soft-consonant-boost-phoneplan-softleadskip-vel-support-finaledge-audibletargetfixed-sourceotopreutter-sustaintexturebody-conditionaledge-restgapend-finaltail-vowelbudget-anchorlead-targetfixed-envelopeend-directparammap-meldomainconcat-waveformsustain-naturalrate-f0fallback-postleveler-loud17-grocv1-genc-hnsepslice-rms-sourceparams-tencremixfix-nonlinearparammap-{HifiHnsepOnnx.CacheKeyOrDisabled()}-enh{MelEnhanceMode}-dbg{DebugExportEnabled}";
        }
